...
export function SolIcon({ size = 13, style, fill }: { size?: number; style?: React.CSSProperties; fill?: string }) {
  const gradId = 'uiSolGrad'
  return (
    <svg width={size} height={size} viewBox="0 0 313 281" fill="none" xmlns="http://www.w3.org/2000/svg"
      ...
      {!fill && (
        <defs>
          <linearGradient id={gradId} x1="26.415" y1="287.059" x2="283.735" y2="-2.49574" gradientUnits="userSpaceOnUse">
